...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="col-md-7">
        <details open>
            ...
            <p class="well">This GridView uses a &lt;asp:TemplateField …&lt;
                 for the table number and the controls to handle walk-in seating. 
                Additionally, the walk-in seating form is in a panel that only shows if the seat is 
                <em>not</em> taken. Handling of the action to <b>seat customers</b>
                 is done in the code-behind, on the GridView's <code>OnSelectedIndexChanging
    ...
    <asp:ObjectDataSource ID="WaitersDataSource" 
        runat="server" OldValuesParameterFormatString="original_{0}" 
        SelectMethod="ListWaiters" TypeName="eRestaurantSystem.BLL.AdminController">
    </asp:ObjectDataSource>

    <!-- this source is to display the Reservations
         for the select dat in a collaspalbe dispaly controlled bt boottstrap-->
    <div class="pull-right col-md-5">
        <details open>
            <!-- collaspalbe area controlled by bootsrtap-->
            ...
            <asp:Repeater ID="ReservationsRepeater" runat="server"
                ...
                <ItemTemplate>
                    <div>
                        ...
                        <!--referring to the DTOs ICollections-->
